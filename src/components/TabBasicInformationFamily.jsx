...
const TabBasicInformationFamily = ({
  ...
  const handleSubmit = async (section) => {
    ...
    const payload = {
      patientId: basicInformation.patientId.value,
                    ...
                    <h4 className="text-lg font-semibold text-sky-700 mb-4">
                     ...
                     onChange={handleChangeBasicInfo}
                      ...
                      <div>
                        ...
                        {basicInformationErrors["husband.gender"] && (
                          <p className="mt-1 text-sm text-red-600">
                            {basicInformationErrors["husband.gender"]}
                          </p>
                        )}
                        ...
                        <div className="flex space-x-4 mt-2">
                          ...
                          <label className="flex items-center">
                            <input
                              ...
                              onChange={(e) => handleChangeBasicInfo(e, "wife")}
                              className="h-4 w-4 text-sky-600 focus:ring-sky-500 border-gray-300"
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-sky-700 mb-4">
                      ...
                      <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <span className="text-gray-800 text-right">
                          {basicInformation.husbandDateOfBirth.value
                            ? moment(basicInformation.husbandDateOfBirth.value).format(
                                "YYYY MMM DD"
                              )
                            : "N/A"}
                        </span>
                      ...
                      <div className="md:col-span-2 flex justify-between items-start p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                        <span className="text-gray-600 font-medium font-semibold">
                          Permanent Address:
                        </span>
                    ...
                    <h4 className="text-lg font-semibold text-sky-700 mb-4">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <span className="text-gray-800 text-right">
                          {basicInformation.wifeDateOfBirth.value
                            ? moment(basicInformation.wifeDateOfBirth.value).format(
                                "YYYY MMM DD"
                              )
                            : "N/A"}
                        </span>
