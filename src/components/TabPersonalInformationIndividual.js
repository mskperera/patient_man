   ...
   <div className="flex space-x-4">
        ...
        {editingSection === "insights" || mode === "add" ? (
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">
                List your main work difficulties{personalInformation.schoolWorkDifficulties.required && <span className="text-red-500">*</span>}
              </label>
              <textarea
          ...
          <div className="space-y-4">
            <div className=" bg-white border border-gray-200 rounded-lg p-4">
             ...
             <div className=" bg-white border border-gray-200 rounded-lg p-4">
              <strong className="text-sm">Main Work Difficulties:</strong>
                <div className="mt-2"> 
              ...
              <div>
                ...
                {personalInformationErrors.occupationTrained && (
                  <p className="mt-1 text-sm text-red-600">{personalInformationErrors.occupationTrained}</p>
                     ...
                     {/* {JSON.stringify(personalInformation.occupationTrained.value)} */}
                {personalInformation.occupationTrained.value==="Other"  &&  
                <><input
                  name="occupationTrainedOther"
                  type="text"
                  value={personalInformation.occupationTrainedOther.value}
                  onChange={handleChangePersonalInfo}
                  className="mt-1 w-full p-3 border text-sm border-gray-300 rounded-md focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-all duration-200"
                  placeholder="Enter the Occupation Trained For"
                  aria-label="Male children ages"
                />
                {personalInformationErrors.occupationTrainedOther && (
                  <p className="mt-1 text-sm text-red-600">{personalInformationErrors.occupationTrainedOther}</p>
                )}
                </>}
              </div>
              ...
              <div>
                ...
                {personalInformationErrors.occupation && (
                  <p className="mt-1 text-sm text-red-600">{personalInformationErrors.occupation}</p>
                     ...
                     {/* {JSON.stringify(personalInformation.occupationTrained.value)} */}
                {personalInformation.occupation.value==="Other"  &&  
                <><input
                  name="occupationOther"
                  type="text"
                  value={personalInformation.occupationOther.value}
                  onChange={handleChangePersonalInfo}
                  className="mt-1 w-full p-3 border text-sm border-gray-300 rounded-md focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-all duration-200"
                  placeholder="Enter the Occupation"
                  aria-label="Male children ages"
                />
                {personalInformationErrors.occupationOther && (
                  <p className="mt-1 text-sm text-red-600">{personalInformationErrors.occupationOther}</p>
                )}
                </>}
              </div>
