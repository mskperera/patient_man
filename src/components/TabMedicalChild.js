...
const TabMedicalChild = ({ id, setActiveTab }) => {
      ...
      <section className="mb-12">
        ...
        {editingSection === "treatment" || mode === "add" ? (
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">
                Number of times during past year you have taken psychiatric treatments{medicalInformation.antidepressantsCount.required && <span className="text-red-500">*</span>}
              </label>
              <input
                type="number"
                min="0"
...
export default TabMedicalChild;