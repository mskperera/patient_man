...
const TabBasicInformation = ({ id, refreshTabDetails, setNewId, patientTypeId }) => {
  ...
  const [basicInformation, setBasicInformation] = useState({
    patientNo: { label: "Patient ID", value: "NEW", isTouched: false, isValid: false, required: true, dataType: "string" },
    firstName: { label: "First Name", value: "", isTouched: false, isValid: false, required: true, dataType: "string" },
    lastName: { label: "Last Name", value: "", isTouched: false, isValid: false, required: true, dataType: "string" },
    middleName: { label: "Middle Name", value: "", isTouched: false, isValid: false, required: false, dataType: "string" },
    dateOfBirth: { label: "Date of Birth", value: "", isTouched: false, isValid: false, required: true, dataType: "date" },
    age: { label: "Age", value: "", isTouched: false, isValid: false, required: true, dataType: "number" },
    gender: { label: "Gender", value: "", isTouched: false, isValid: false, required: true, dataType: "string" },
    email: { label: "Email", value: "", isTouched: false, isValid: false, required: false, dataType: "email" },
    homePhone: { label: "Home Phone", value: "", isTouched: false, isValid: false, required: true, dataType: "phone" },
    businessPhone: { label: "Mobile Phone", value: "", isTouched: false, isValid: false, required: false, dataType: "phone" },
    permanentAddress: { label: "Permanent Address", value: "", isTouched: false, isValid: false, required: true, dataType: "string" },
    referralSource: { label: "Referral Source", value: "", isTouched: false, isValid: false, required: true, dataType: "string" },
    referralSourceOther: { label: "Referral Source Other", value: "", isTouched: false, isValid: false, required: false, dataType: "string" },
    referralPartyPresent: { label: "Referral Party Present", value: false, isTouched: false, isValid: false, required: true, dataType: "boolean" },
  });
  ...
  const loadBasicInformationData = async () => {
    ...
    try {
      ...
      if (patientData.error) {
        ...
        setBasicInformation({
          patientNo: { ...basicInformation.patientNo, value: patientData.patientNo || "", isTouched: false, isValid: true },
          firstName: { ...basicInformation.firstName, value: patientData.firstName || "", isTouched: false, isValid: true },
          lastName: { ...basicInformation.lastName, value: patientData.lastName || "", isTouched: false, isValid: true },
          middleName: { ...basicInformation.middleName, value: patientData.middleName || "", isTouched: false, isValid: true },
          dateOfBirth: { ...basicInformation.dateOfBirth, value: patientData.dateOfBirth ? moment(patientData.dateOfBirth).format("YYYY-MM-DD") : "", isTouched: false, isValid: true },
          age: { ...basicInformation.age, value: patientData.age?.toString() || "", isTouched: false, isValid: true },
          gender: { ...basicInformation.gender, value: patientData.gender || "", isTouched: false, isValid: true },
          email: { ...basicInformation.email, value: patientData.email || "", isTouched: false, isValid: true },
          homePhone: { ...basicInformation.homePhone, value: patientData.homePhone || "", isTouched: false, isValid: true },
          businessPhone: { ...basicInformation.businessPhone, value: patientData.businessPhone || "", isTouched: false, isValid: true },
          permanentAddress: { ...basicInformation.permanentAddress, value: patientData.permanentAddress || "", isTouched: false, isValid: true },
          referralSource: { ...basicInformation.referralSource, value: patientData.referralSource || "", isTouched: false, isValid: true },
          referralSourceOther: { ...basicInformation.referralSourceOther, value: patientData.referralSourceOther || "", isTouched: false, isValid: true },
          referralPartyPresent: { ...basicInformation.referralPartyPresent, value: !!patientData.referralPartyPresent, isTouched: false, isValid: true },
        });
      }
    } catch (error) {
  ...
  const handleSubmitBasicInformation = async (e) => {
    ...
    try {
      ...
      setMode("edit");
      setIsSaving(false);
      navigate(`/patient?id=${res.data.outputValues.patientId}&type=${patientTypeId}`);
    } catch (err) {
      setModal({ isOpen: true, message: err.message, type: "error" });
      setIsSaving(false);
    }
            ...
            {mode !== "add" && (
              <div className="flex space-x-3">
                <button
                  ...
                  aria-label={editingSection === "basic" ? (isSaving ? "Saving Basic Info" : "Save Basic Info") : "Edit Basic Info"}
                  disabled={isSaving}
                >
          ...
          {isLoading ? (
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
              <div className="space-y-8">
                {/* Personal Details */}
                <div>
                  <h4 className="text-lg font-semibold text-sky-700 mb-4">Personal Details</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div>
                      ...
                      {basicInformationErrors.lastName && (
                        <p className="mt-1 text-sm text-red-600">{basicInformationErrors.lastName}</p>
                      )}
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-600">
                      ...
                      {basicInformationErrors.firstName && (
                        <p className="mt-1 text-sm text-red-600">{basicInformationErrors.firstName}</p>
                      )}
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      {basicInformationErrors.dateOfBirth && (
                        <p className="mt-1 text-sm text-red-600">{basicInformationErrors.dateOfBirth}</p>
                      )}
                    </div>
                    <div>
                      ...
                      <div className="flex items-center gap-2 p-3 text-sm border border-gray-300 rounded-lg bg-gray-50">
                        <span className="text-gray-800 font-medium">{basicInformation.age.value || "N/A"}</span>
                    ...
                    <div>
                      ...
                      {basicInformationErrors.gender && (
                        <p className="mt-1 text-sm text-red-600">{basicInformationErrors.gender}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                {/* Contact Information */}
                <div>
                  <h4 className="text-lg font-semibold text-sky-700 mb-4">Contact Information</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-gray-600">
                      ...
                      {basicInformationErrors.homePhone && (
                        <p className="mt-1 text-sm text-red-600">{basicInformationErrors.homePhone}</p>
                      )}
                    </div>
                    <div>
                      ...
                      {basicInformationErrors.businessPhone && (
                        <p className="mt-1 text-sm text-red-600">{basicInformationErrors.businessPhone}</p>
                      )}
                    </div>
                    <div>
                      ...
                      {basicInformationErrors.email && (
                        <p className="mt-1 text-sm text-red-600">{basicInformationErrors.email}</p>
                      )}
                    </div>
                    <div className="md:col-span-2 lg:col-span-3">
                      ...
                      {basicInformationErrors.permanentAddress && (
                        <p className="mt-1 text-sm text-red-600">{basicInformationErrors.permanentAddress}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-sky-700 mb-4">Referral Information</h4>
                  <div className="space-y-6">
                    <div>
                      <label className="block text-sm font-medium text-gray-600">
                        Who referred you to the Institute? <span className="text-red-500">*</span>
                      </label>
                        ...
                        {["Self", "School or Teacher", "Psychologist or Psychiatrist", "Social Agency", "Hospital or Clinic", "Family Doctor", "Friend", "Relative", "Other"].map((source) => (
                          <label key={source} className="flex items-center">
                            <input
                              ...
                              checked={basicInformation.referralSource.value === source.toLowerCase()}
                              onChange={handleChangeBasicInfo}
                              className="h-4 w-4 text-sky-600 focus:ring-sky-500 border-gray-300"
                              aria-label={source}
                            />
                      ...
                      {basicInformationErrors.referralSource && (
                        <p className="mt-2 text-sm text-red-600">{basicInformationErrors.referralSource}</p>
                      )}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-600">
                        Has this party been here? <span className="text-red-500">*</span>
                      </label>
                      <div className="flex space-x-4 mt-2">
                        <label className="flex items-center">
                          <input
                            ...
                            value={true}
                            checked={basicInformation.referralPartyPresent.value === true}
                        ...
                        <label className="flex items-center">
                          <input
                            ...
                            name="referralPartyPresent"
                            value={false}
                            checked={basicInformation.referralPartyPresent.value === false}
                            onChange={handleChangeCheckBox}
                            className="h-4 w-4 text-sky-600 focus:ring-sky-500 border-gray-300"
                            aria-label="No"
                          />
                      ...
                      {basicInformationErrors.referralPartyPresent && (
                        <p className="mt-2 text-sm text-red-600">{basicInformationErrors.referralPartyPresent}</p>
                      )}
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">First Name:</span>
                      <span className="text-gray-800 text-right">{basicInformation.firstName.value || "N/A"}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">Last Name:</span>
                      <span className="text-gray-800 text-right">{basicInformation.lastName.value || "N/A"}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">Middle Name:</span>
                      <span className="text-gray-800 text-right">{basicInformation.middleName.value || "N/A"}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">Date of Birth:</span>
                      <span className="text-gray-800 text-right">{basicInformation.dateOfBirth.value ? moment(basicInformation.dateOfBirth.value).format("YYYY MMM DD") : "N/A"}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">Age:</span>
                      <span className="text-gray-800 text-right">{basicInformation.age.value || "N/A"} Years</span>
                    </div>
                    <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">Gender:</span>
                      <span className="text-gray-800 text-right">{basicInformation.gender.value || "N/A"}</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">Home Phone:</span>
                      <span className="text-gray-800 text-right">{basicInformation.homePhone.value || "N/A"}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">Mobile Phone:</span>
                      <span className="text-gray-800 text-right">{basicInformation.businessPhone.value || "N/A"}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">Email:</span>
                      <span className="text-gray-800 text-right">{basicInformation.email.value || "N/A"}</span>
                    </div>
                    <div className="md:col-span-2 lg:col-span-3 flex justify-between items-start p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">Permanent Address:</span>
                      <span className="text-gray-800 text-right max-w-[70%]">{basicInformation.permanentAddress.value || "N/A"}</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">Referral Source:</span>
                      <span className="text-gray-800 text-right">
                        {basicInformation.referralSource.value === "other" ? basicInformation.referralSourceOther.value : basicInformation.referralSource.value || "N/A"}
                      </span>
                    </div>
                    <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                      <span className="text-gray-600 font-medium font-semibold">Referral Party Present:</span>
                      <span className="text-gray-800 text-right">{basicInformation.referralPartyPresent.value ? "Yes" : "No"}</span>
                    </div>
                  </div>
                </div>
              </div>
...
//   referralSource: basicInformation.referralSource.value,
//   referralSourceOther:basicInformation.referralSourceOther.value,
//   referralPartyPresent: basicInformation.referralPartyPresent.value,
//   utcOffset: "+05:30",
//   pageName: "PatientRegistration",
//   patientTypeId,
//   isConfirm: true
...
//   referralSource: basicInformation.referralSource.value,
//     referralSourceOther:basicInformation.referralSourceOther.value,
//   referralPartyPresent: basicInformation.referralPartyPresent.value===true?1:0,
//   utcOffset: "+05:30",
//   pageName: "PatientRegistration",
//   patientTypeId,
//   isConfirm: true
...
//               <button
//                 onClick={() => toggleSectionEdit("basic")}
//             className={`flex items-center px-4 py-2 rounded-lg bg-transparent text-sky-600 hover:text-sky-800 transition-colors duration-200
//               disabled:bg-gray-200 disabled:text-gray-400 disabled:border-gray-300 disabled:shadow-none 
...
//              <div>
//               <label className="block text-sm font-medium text-gray-700">
//                 Mobile Phone {basicInformation.businessPhone.required && <span className="text-red-500">*</span>}
//               </label>
//               <input
//                 name="businessPhone"
//                 value={basicInformation.businessPhone.value}
...
//                         value={true}
//                         checked={
//                           basicInformation.referralPartyPresent.value === true
//                         }
//                         onChange={handleChangeCheckBox}
//                         className="h-4 w-4 text-sky-600 focus:ring-sky-500 border-gray-300"
//                         aria-label="Yes"
...
//                         value={false}
//                         checked={
//                           basicInformation.referralPartyPresent.value === false
//                         }
//                         onChange={handleChangeCheckBox}
//                         className="h-4 w-4 text-sky-600 focus:ring-sky-500 border-gray-300"
//                         aria-label="No"
...
//                 <span className="text-gray-800 w-1/2 text-right">{(basicInformation.referralPartyPresent?.value===true ?"Yes":"No") || "N/A"}</span>
//               </div>
//             </div>
//           </div>
//         </div>
